...
(function e(t, n, r) {
    ...
    4 : [function(require, module, exports) {
        var GIFEncoder, renderFrame,renderFrames;
        ...
        renderFrames = function(frames){
            ...
            if (frame.canTransfer) {
                ...
                //return ;
                //return worker.postMessage(result, transfer)
            } else {
        ...
        renderFrame = function(frame) {
            ...
            if (frame.canTransfer) {
                ...
                return worker.postMessage(frame, transfer)
            } else {
